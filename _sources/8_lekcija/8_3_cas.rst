...
- Цифру стотину обијамо тако што број прво целобројно поделимо са 100 (чиме цифра стотина долази скроз десно) а затим нађемо остатак при дељењу броја са 10.
