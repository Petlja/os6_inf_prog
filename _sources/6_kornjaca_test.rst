...
.. mchoice:: 4
    ...
    Шта недостаје у следећем коду да би била исцртана фигура као на слици? Изабери тачан одговор:
...
.. mchoice:: 7
    ...
    Који од понуђених кодва исцртава звезду као на слици? Изабери тачан одговор:
