...
.. infonote::
   ...
   Функције су вишеструко корисне приликом програмирања, издвојићемо следеће:
            - Функције доприносе да наш програм буде краћи и читљивији јер се програмирају на једном
            ...
            - Функције омогућавају поделу посла у програмерском тиму где свако добије део посла,
              обично је то да испрограмира неке функције а после се цео програм склапа у целину (чине програм модуларним)
...
.. infonote::
  Коришћење уграђених (библиотечких) функција и дефинисање сопствених функција можете провежбати кроз 
