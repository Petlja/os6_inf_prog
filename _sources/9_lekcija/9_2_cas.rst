...
.. infonote::
   ...
   Функције су вишеструко корисне приликом програмирања, а издвојићемо следеће:
            - Функције доприносе томе да наш програм буде краћи и читљивији јер се програмирају на једном
              месту, а после се само позивају.
            ...
            - Функције омогућавају поделу задатака у програмерском тиму, где свако добије одређени део посла,
              најчешће да испрограмира неке функције, а после се цео програм склапа у целину (функције чине програм модуларним).
...
(као што је наведено у примеру) тело функције представља
...
У претходном примеру, позив функција је гласио obim_pravougaonika(4.2, 5.7), а 
бројеви 4.2 и 5.7 су у том примеру аргументи (параметри) функције
...
израчунати по формули :math:`P = r^2\pi`, где је  :math:`\pi = 3,1415926...`, 
а у језику *Python* се може добити помоћу `math.pi`).
