...
.. mchoice:: 7
    ...
    Који од наредних кодова треба да се изврши како би резултат био као на приложеној слици?
    
    .. image:: ../../_images/kvadrati.png      
        :align: center
...
.. mchoice:: 8
    ...
    Шта је резултат извршавања наредног кода?
