...
.. figure:: ../../_images/idle-shell_win.png
   :width: 780px   
   :align: center
...
.. figure:: ../../_images/idle-editor_win.png
   :width: 780px   
   :align: center
   :class: screenshot-shadow
...
.. technicalnote::
   ...
   тако што се покрене команда ``python <ime_skripta>`` или ``python3 <ime_skripta>``).
...
.. Овде видео обухвата ову лекцију и наредну, сад то не може да се мења, мало збуњује
